...
<form action="add_property.php" method="post" autocomplete="off">
    <div id=col1>
        ...
        <span>
            ...
            <input type="text" name="no_of_units" id="no_of_units" required minlength="1" maxlength="3" min="1" onchange="this.value = Math.floor(Math.max(this.value,1))" pattern="^[0-9]+$">
