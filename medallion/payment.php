...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Intramuros Online Ticketing</a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="dex.php"><span class="glyphicon glyphicon-backward"></span> Back To Home</a></li>
    </ul>
  </div>
</nav>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">2. TOUR AND PRICING
								</h3>
							</div>
							<div class="panel-body">
								TOTAL TRAVELLERS
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			...
			 			<i>Estimated Time to Complete: The Following Day @3:00PM</i><br />
			 			<strong>
			 ...
			 <div class="panel panel-success">
				...
				PASSENGERS</strong>
					<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						   ...
						   <center>
							   <a href="dex.php" class="btn btn-success">Return Home
